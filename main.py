...
async def main():
    ...
    for symbol in Config.SYMBOLS:
        outputs = {}  # Create new outputs dictionary for each symbol
        ...
        # Run analysis for current symbol
        initial_state = {
            "symbol": symbol,
            "stock_data": {},
            "company_info": {},
        ...
        outputs_list.append(outputs)  # Add the outputs for this symbol to the list
